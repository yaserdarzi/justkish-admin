...
{
    //User Type
    Const TYPE_USER_CUSTOMER = "customer";
    Const TYPE_USER_DESIGNER = "designer";

    //DataBaseName
    const USERS_DB = 'users';
    const PASSWORD_RESETS_DB = 'password_resets';
    const CATEGORY_DB = 'category';
    const CATEGORY_PLAN_DB = 'category_plan';
    const CATEGORY_TIMING_DB = 'category_timing';
    const PROJECT_DB = 'project';
    const PROJECT_FILE_DB = 'project_file';
    const PROJECT_INVOICE_DB = 'project_invoice';
...
//    const VENTURE_DB = 'venture';
//    const USER_VENTURE_DB = 'user_venture';
//    const VENTURE_MEDIA_DB = 'venture_media';
//    const USER_AFFILIATE_DB = 'user_affiliate';
//    const LISTING_DB = 'listing';
//    const LISTING_MEDIA_DB = 'listing_media';
//    const PURCHASES_DB = 'purchases';
