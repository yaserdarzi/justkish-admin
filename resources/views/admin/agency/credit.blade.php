...
@section('content')
    <!-- Page Header -->
    <form method="POST" action="{{url('agency')}}/{{$wallet->agency_id}}/credit"
          files="true" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <header class="page-header">
            <div class="content">
                <div class="title">
                    <h1> افزایش و کاهش اعتبار </h1>
                </div>
                <div class="functions">
                            ...
                            <ul class="tabs-contents">
                                <li id="tab-lang-fa">
                                    <div class="form-title">
                                        <div class="field">
                                            <label><span class="icon-map-pin"></span> مبلغ اعتبار</label>
                                            <label class="title lg">{{number_format($wallet->credit_price)}}</label>
                                        </div>
                                    </div>
                                    <div class="form-title">
                                        <div class="field">
