...
@section('content')
    <!-- Page Header -->
    <form method="POST"
          action="{{url('category/'.$category_id.'/timing')}}@if(isset($editValue))/{{$editValue->id}}@endif"
        ...
        <header class="page-header">
            <div class="content">
                ...
                <div class="functions">
                    <button onclick="location.href='{{url('category/'.$category_id.'/timing')}}';"
                            type="button"
                            class="white"> بازگشت
                    </button>
                    @if(isset($editValue))
                        ...
                        <article>
                            <ul class="tabs-contents">
                                <li id="tab-lang-fa">
                                    ...
                                    <div class="form-title">
                                        <div class="field">
                                            <label for="time"><span class="icon-map-pin"></span>زمان</label>
                                            <input type="text" id="time" name="time"
                                                   placeholder="زمان"
                                                   onkeypress="return onlynumber(event);"
                                                   value="{{old('time')}}@if(isset($editValue)){{$editValue->time}}@endif"
                                                   class="title lg">
                                        </div>
                                    </div>
                                    <div class="form-title">
