                        ...
                        <article>
                            <ul class="tabs-contents">
                                <li id="tab-lang-fa">
                                                ...
                                                <select id="group_features_id" name="group_features_id">
                                                    @if(isset($groupFeaturesInfo))
                                                        @foreach($groupFeaturesInfo as $key=>$value)
                                                            <option
                                                                @if(isset($editValue)) @if($editValue->group_features_id==$value->id){{'selected'}}@endif @else @if(old('group_features_id')==$value->title){{'selected'}}@endif @endif  value="{{$value->id}}">{{$value->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-title">
                                        <div class="field">
                                            <label for="categories_id"><span class="icon-map-pin"></span>گروه</label>
                                            <div class="select">
                                                <select id="categories_id" name="categories_id">
                                                    @if(isset($categoriesInfo))
                                                        @foreach($categoriesInfo as $key=>$value)
                                                            <option
                                                                @if(isset($editValue)) @if($editValue->categories_id==$value->id){{'selected'}}@endif @else @if(old('categories_id')==$value->title){{'selected'}}@endif @endif  value="{{$value->id}}">{{$value->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-title">
                                        <div class="field">
                                            <label for="brand_id"><span class="icon-map-pin"></span>برند</label>
                                            <div class="select">
                                                <select id="brand_id" name="brand_id">
                                                    @if(isset($brandInfo))
                                                        @foreach($brandInfo as $key=>$value)
                                                            <option
                                                                @if(isset($editValue)) @if($editValue->brand_id==$value->id){{'selected'}}@endif @else @if(old('brand_id')==$value->title){{'selected'}}@endif @endif  value="{{$value->id}}">{{$value->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-title">
                                                <div class="field">
                                                    ...
                                                    <select class="js-example-basic-multiple tagSearch"
                                                        ...
                                                        <?php $featuresQuestionsAnswers = App\FeaturesQuestionsAnswers::where(['features_id' => $value->id, "status" => 1])->get();?>
                                                    ...
                                                    <div class="fileuploader-item-inner">
                                                        <div class="thumbnail-holder">
                                                            <div class="fileuploader-item-image"><img
                                                                    ...
                                                                    src="{{$value->image}}"
                                                                    @else
                                                                    src="{{asset('files/products/'.$editValue->id.'/'.$value->image)}}"
                                                                    @endif
                                                                    draggable="false"></div>
                                                        </div>
