    ...
    <header class="page-header">
        <div class="content">
            ...
            <div class="functions">
                ...
                <button onclick="location.href='{{url('products/'.$product_id.'/supplier/create')}}';"
        ...
        <section class="panel">
            <article class="p0">
                <table class="table">
                    ...
                    <tbody>
                    @foreach($productSupplierInfo as $key=>$value)
                        <tr>
                            ...
                            <td class="td-button" style="width: 100px;">
                                <a href="{{url('products/'.$product_id.'/supplier/'.$value->id.'/edit')}}"
                                ...
                                <form id="form-delete-supplier-{{$value->id}}"
                                      action="{{url('products/'.$product_id.'/supplier/'.$value->id)}}"
                                      method="post">
                                    {!! csrf_field() !!}
