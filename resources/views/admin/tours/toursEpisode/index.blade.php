...
@section('content')
    ...
    <header class="page-header">
        <div class="content">
            ...
            <div class="functions">
                ...
                <button onclick="location.href='{{url('tours/'.$tour_id.'/episode/create')}}';"
    ...
    <div class="main-content">
        <section class="panel">
            <article class="p0">
                <table class="table">
                    ...
                    <tbody>
                    @foreach($tourEpisodeInfo as $key=>$value)
                        <tr>
                            ...
                            {{--<td>{{$value->name}}</td>--}}
                            <td>
                                <?php $countFactorEpisode = \App\FactorDetails::where('tour_episode_id', $value->id)->count();?>
                            ...
                            <td class="td-button" style="width: 100px;">
                                <a href="{{url('tours/'.$tour_id.'/episode/'.$value->id.'/edit')}}"
        ...
        <div class="paginate tal">
            <ul class="pagination">
                @if($tourEpisodeInfo->hasPages())
                    <?php echo $tourEpisodeInfo->render();?>
                @endif
            </ul>
        </div>
    </div>
