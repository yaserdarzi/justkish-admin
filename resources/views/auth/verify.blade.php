            ...
            <article>
                ...
                <form method="POST" action="{{url('auth/verify')}}">
                    ...
                    <div class="field icon right lg ">
                        <input type="text" data-type="onlyNumber" maxlength="11" readonly
                               name="phone" value="{{$phone}}" placeholder="تلفن همراه">
                        <div class="icon-user"></div>
                    </div>
                    <div class="field icon right lg ">
                        <input type="text" data-type="onlyNumber" maxlength="4"
                               name="code" value="{{ old('code') }}" placeholder="کد">
                        <div class="icon-user"></div>
                    </div>
                    <footer>
